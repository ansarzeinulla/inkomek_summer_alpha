...
public class cabinet_inclusive extends AppCompatActivity {
String login;
...
Integer oldpoint;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cabinet_inclusive);
        if (savedInstanceState == null) {
            Bundle extras = getIntent().getExtras();
            if(extras==null) {
                login=null;
                Toast.makeText(cabinet_inclusive.this, "ERROR PLS GO BACK", Toast.LENGTH_LONG).show();
                Intent intent=new Intent(cabinet_inclusive.this,enter_inclusive.class);
        ...
        TextView c1=findViewById(R.id.cabI1);
        TextView c2=findViewById(R.id.cabI2);
...
//        EditText e1=findViewById(R.id.cabI21);
        ...
        TextInputLayout e0=findViewById(R.id.cabI20);
        TextInputLayout e1=findViewById(R.id.cabI21);
        TextInputLayout e2=findViewById(R.id.cabI22);
        TextInputLayout e3=findViewById(R.id.cabI23);
//        Button btn1=findViewById(R.id.cabIbutton1);
        Button btn2=findViewById(R.id.cabIbutton2);
...
//        });
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                //change value
                DatabaseReference newhuman=FirebaseDatabase.getInstance().getReference("inclusives").child(login);
